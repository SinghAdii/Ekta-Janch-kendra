...
interface SchedulePickupPageProps {
  onSuccess?: (data: SchedulePickupForm & { orderNumber: string; totalAmount: number }) => void;
}

export default function SchedulePickupPage({ onSuccess }: SchedulePickupPageProps) {
  ...
  const form = useForm<SchedulePickupForm>({
    resolver: zodResolver(schedulePickupFormSchema),
    defaultValues: {
      fullName: "",
      mobile: "",
      email: "",
  ...
  const onSubmit = async (data: SchedulePickupForm) => {
  ...
  return (
    <div className="h-full flex flex-col overflow-hidden bg-gradient-to-br from-emerald-50 via-white to-slate-50 dark:from-gray-950 dark:via-gray-900 dark:to-gray-950">
      <div className="flex-1 p-4 md:p-6 space-y-4 overflow-y-auto">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
          <div className="flex items-center gap-3">
            <div className="p-2.5 bg-emerald-100 rounded-xl dark:bg-emerald-900/30 shrink-0">
              <Home className="h-5 w-5 text-emerald-600 dark:text-emerald-400" />
            </div>
            <div>
              <h1 className="text-lg md:text-xl font-bold tracking-tight">Schedule Home Collection</h1>
              <p className="text-xs text-muted-foreground hidden sm:block">
                Register a new home sample collection
              </p>
            </div>
          </div>
        </div>
            ...
            >
              <Card className="border-green-200 bg-green-50">
                <CardContent className="p-3 flex items-center gap-3">
                  ...
                  <div>
                    <p className="font-medium text-green-800 text-sm">Pickup Scheduled!</p>
                    <p className="text-xs text-green-600">View it in Home Collection orders.</p>
                  </div>
                </CardContent>
              </Card>
            </motion.div>
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem className="col-span-2">
                          ...
                          <FormControl>
                            <Input placeholder="House no, Street, Area" className="h-9" {...field} />
                          </FormControl>
                          <FormMessage className="text-xs" />
                        </FormItem>
                      )}
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <FormControl>
                            <Input placeholder="Near..." className="h-9" {...field} />
                          </FormControl>
                          <FormMessage className="text-xs" />
                        </FormItem>
                      )}
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <FormControl>
                            <Input placeholder="6 digit pincode" className="h-9" maxLength={6} {...field} />
                          </FormControl>
                          <FormMessage className="text-xs" />
                        </FormItem>
                      )}
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <FormControl>
                            <Input type="date" min={getMinDate()} className="h-9" {...field} />
                          </FormControl>
                          <FormMessage className="text-xs" />
                        </FormItem>
                      )}
                          ...
                          <Select onValueChange={field.onChange} value={field.value}>
                            ...
                            <SelectContent>
                              {timeSlots.filter(s => s.available).map((slot) => (
                                <SelectItem key={slot.id} value={slot.id}>{slot.display}</SelectItem>
                              ))}
                            </SelectContent>
                          </Select>
                          <FormMessage className="text-xs" />
                    ...
                    <CardContent className="p-4">
                      <div className="flex items-center justify-between">
                        ...
                        <div className="text-right">
                          ...
                          <p className="text-xl font-bold text-emerald-600 flex items-center justify-end">
                          ...
                          return (
                            <div
                              ...
                              className={cn(
                                ...
                                isSelected ? "border-emerald-500 bg-emerald-50 dark:bg-emerald-900/20" : "border-gray-200 hover:border-emerald-200 dark:border-gray-700"
                              )}
                            >
                              <Checkbox
                                checked={isSelected}
                              ...
                              <div className="flex-1 min-w-0">
                                <div className="flex items-start justify-between gap-2">
                                  ...
                                  <p className="font-semibold text-emerald-600 text-xs flex items-center shrink-0">
                                  ...
                                  <Collapsible>
                                    <CollapsibleTrigger asChild>
                                      <Button
                                        ...
                                        variant="ghost"
                                        size="sm"
                                        className="text-[10px] text-emerald-600 p-0 h-auto mt-1"
                                        onClick={(e) => e.stopPropagation()}
                                      >
